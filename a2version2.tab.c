...
#ifndef YY_YY_A2VERSION2_TAB_H_INCLUDED
...
#endif /* !YY_YY_A2VERSION2_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "SECTION1", "SECTION2", "SECTION3",
  "NEWLINE", "NUM", "ID", "IF", "THEN", "ELSE", "END", "WHILE", "CALL",
  "WITH", "OR", "AND", "NOT", "NEG", "PLAY", "RETURN", "'='", "'['", "']'",
  "'{'", "'}'", "'('", "')'", "'+'", "'-'", "'*'", "$accept", "START",
  "PRIMITIVE", "ENGINE", "FUNCTIONS", "FUNCTION", "BODY", "STATEMENT",
  "IFSTATEMENT", "WHILELOOP", "EXPR", "ARITHLOGIC", "TERM", "ARITH1",
  "FACTOR", "TERM1", "PARAM", "PARAMLIST", YY_NULLPTR
};
#endif
...
static const yytype_int16 yytoknum[] =
{
     ...
     275,   276,    61,    91,    93,   123,   125,    40,    41,    43,
      45,    42
};
# endif
...
#line 1801 "a2version2.tab.c"
    break;


#line 1805 "a2version2.tab.c"
